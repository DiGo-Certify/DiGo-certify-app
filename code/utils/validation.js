...
export const validateValidationForm = form => {
    ...
    if (walletError) {
        errors.userAddress = walletError;
    }

    if (!form.certificateProvided && !form.certificateLink) {
        errors.certificateLink = 'Please upload a certificate or insert a URL';
    } else if (form.certificateLink) {
